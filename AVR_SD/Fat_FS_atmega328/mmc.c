...
#define CS_LOW()	PORTB &= ~(1<< PB2)			/* MMC CS = L Mod for Atmega328 June23/11*/ 
#define	CS_HIGH()	PORTB |= (1	<< PB2)		/* MMC CS = H *Mod for Atmega328 June23/11/
// comented out June23/11 #define SOCKWP		(PINB & 0x20)		/* Write protected. yes:true, no:false, default:false */
// comented out June23/11 #define SOCKINS		(!(PINB & 0x10))	/* Card detected.   yes:true, no:false, default:true */
...
// This is the old chk_power function it is modified to return 1 
// because there is no power control on this implementation
static
...
/* (Platform dependent)                  */
// This is timerproc corrected as per avrfreak info June 22/2011
