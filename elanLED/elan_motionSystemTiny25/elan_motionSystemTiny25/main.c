...
int main(void)
{
	...
	*/
	uint16_t motion_length = 250, motion_array[motion_length];
	uint16_t static_length = 250, static_array[static_length];
	...
	uint8_t T_blink_nomotion = 50, T_blink_return = 100;
